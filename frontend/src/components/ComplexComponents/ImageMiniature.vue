...
export default {
	...
	mounted: async function () {
		try {
			...
			this.imageData = null;
			store.dispatch("PUSH_NEW_IMAGE", { _id: this.imgId, data: null, size: "mini" });
		}
	},
...
<template>
	<figure v-if="imageData" class="flex-none w-32 h-32 rounded overflow-hidden drop-shadow-lg relative group">
		<div
